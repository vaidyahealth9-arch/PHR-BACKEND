...
COMMIT_MSG = "feat(auth): switch back to vaidya-phr-dev, update firebase keys, password login endpoints, and deploy workflow env injections"
...
def safe_sync(repo):
    ...
    # 2. Check local uncommitted changes on main and commit them
